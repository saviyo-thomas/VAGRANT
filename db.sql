...
drop table orders;
select * from orders;
ALTER TABLE orders  MODIFY order_id int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
CREATE TABLE `admins` (
  `user_id` int(10) NOT NULL,
  `user_email` varchar(255) NOT NULL,
  `user_pass` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
INSERT INTO `admins` (`user_id`, `user_email`, `user_pass`) VALUES (2, 'admin@gmail.com', 'admin');
CREATE TABLE `cart` (
...
(7, '::2', 'Modric', 'modric@gmail.com', '123456', 'iuthd75323h', 'Croatia', 'Madrid', '09876543', 'pqr street, Madrid', 'modric.jpg'),
(8, '::3', 'Gareth Bale', 'bale@gmail.com', '12345678', 'asfkajfgkjasdhfk', 'England', 'Madrid', '1234678', 'pqr street, Madrid', 'bale.jpg'),
(9, '::4', 'Toni Kroos', 'kroos@gmail.com', '123456', '12345678', 'Spain', 'Madrid', '123123813', 'abcd street', '53302383_2313952138849356_535954198475309056_n.jpg'),
(10, '::5', 'Dani Carvajal', 'dani@gmail.com', '123456', '121231', '--Select--', 'Madrid', 'asdasdasd', 'asdasdas', '13680916_523659327839565_4622168564214662790_n.png');
...
SELECT package_title FROM packages WHERE package_id=1;
